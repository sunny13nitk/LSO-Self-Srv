...
public interface IF_SrvCloudAPI
{
        ...
        // public List<TY_CaseESS> getCases4User(String accountIdUser,
        // TY_DestinationProps desProps) throws IOException;

        // public List<TY_CaseESS> getCases4User(Ty_UserAccountEmployee userDetails,
        // TY_DestinationProps desProps)
        // throws IOException;
        ...
        // public Long getNumberofCases(TY_DestinationProps desProps) throws
        // IOException;

        // public JsonNode getAllAccounts(TY_DestinationProps desProps) throws
        // IOException;

        // public JsonNode getAllEmployees(TY_DestinationProps desProps) throws
        // IOException;

        // public JsonNode getAllContacts(TY_DestinationProps desProps) throws
        // IOException;
        ...
        // public String createCase(TY_Case_Customer_SrvCloud caseEntity,
        // TY_DestinationProps desProps) throws EX_ESMAPI;

        // public String createCase4Employee(TY_Case_Employee_SrvCloud caseEntity,
        // TY_DestinationProps desProps)
        // throws EX_ESMAPI;

        // public String createCase4Customer(TY_Case_Customer_SrvCloud caseEntity,
        // TY_DestinationProps desProps)
        // throws EX_ESMAPI;

        // public String createCase4EmployeeAddUser(TY_Case_EmployeeAddUser_SrvCloud
        // caseEntity,
        // TY_DestinationProps desProps) throws EX_ESMAPI;

        // public String createCase4EmployeeAddUserIC(TY_Case_AddUserIC_SrvCloud
        // caseEntity, TY_DestinationProps desProps)
        // throws EX_ESMAPI;

        // public String createCase4CustomerAddUser(TY_Case_CustomerAddUser_SrvCloud
        // caseEntity,
        // TY_DestinationProps desProps) throws EX_ESMAPI;

        // public String getContactPersonIdByUserEmail(String userEmail,
        // TY_DestinationProps desProps) throws EX_ESMAPI;
